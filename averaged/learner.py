...
class learner:
    ...
    def UCRL(self, alpha, n_rounds, pi_no_attack, M_0, M_t, cost_y_axis, costr, costp):
        regret_array = []
        ...
        for t in range(1,int(n_rounds)):
            ...
            accumulated_cost_no_attack_count += self.compute_accumulated_cost_no_attack(s_t, a_t, M_t, M_0, cost_y_axis, costr, costp)
