...
if __name__ == "__main__":
    ...
    plot_grid.plot_offline_teaching_vary_c(dict_file=dict_accumulator, each_number=1, show_plots=False)

        # print(acc_dict)
        # write_into_file(acc_dict, exp_iter=iter_num, teacher_type="offline_teaching_vary_c_grid_costr={}_costp={}".format(costr, costp))
    exit(0)
